...
.service('ViewService', function($location, $http, $translate, $cordovaInAppBrowser, $cordovaNetwork, $ionicPopup, $ionicLoading, PROXIMITY_PLATFORM, ApiService, DebugService, BeaconService, GeofenceService, DataService) {
